...
if __name__ == "__main__":
    ...
    try:
        ...
        print("Bjarke: Correct: {} Wrong: {} Accuracy: {}".format(accuracy_per[b_index],
                                                                  ...
                                                                  (accuracy_per[b_index] / accuracy_count[b_index])))
        print("Monica: Correct: {} Wrong: {} Accuracy: {}".format(accuracy_per[m_index],
                                                                  (accuracy_count[m_index] - accuracy_per[m_index]),
                                                                  (accuracy_per[m_index] / accuracy_count[m_index])))
        print("Wenche: Correct: {} Wrong: {} Accuracy: {}".format(accuracy_per[w_index],
                                                                  (accuracy_count[w_index] - accuracy_per[w_index]),
                                                                  (accuracy_per[w_index] / accuracy_count[w_index])))
    except:
        pass
    print()
    print("Alex pic results: A:{} B:{} G:{} M:{} W:{}".format(alex_pic[a_index], alex_pic[b_index], alex_pic[g_index],
                                                              alex_pic[m_index], alex_pic[w_index]))
    print(
        "Gabbi pic results: A:{} B:{} G:{} M:{} W:{}".format(gabbi_pic[a_index], gabbi_pic[b_index], gabbi_pic[g_index],
                                                             gabbi_pic[m_index], gabbi_pic[w_index]))
